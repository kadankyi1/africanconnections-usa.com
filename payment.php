            ...
            <div class="rd-navbar-aside-outer">
              <div class="rd-navbar-aside">
                ...
                <div class="rd-navbar-aside-right rd-navbar-collapse">
                  ...
                  <a class="button button-md button-default-outline-2 button-ujarak" href="#">Request A Quote</a>
                </div>
              </div>
            </div>
            ...
            <div class="col-sm-8 col-md-6 col-lg-5">
              <article class="box-contacts">
                <div class="box-contacts-body">
                  ...
                  <div class="box-contacts-decor"></div>
                  <p class="box-contacts-link"><a href="mailto:#">info@africanconnections-usa.com</a></p>
                </div>
              </article>
            </div>
          </div>
                  ...
                  <div class="wow slideInRight" data-wow-delay="0s">
                    ...
                    <ul class="footer-contacts d-inline-block d-sm-block">
                      <li>
                        <div class="unit">
                          <div class="unit-left"><span class="icon fa fa-phone"></span></div>
                          <div class="unit-body"><a class="link-phone" href="tel:#"> +1 (847) 893-9304</a></div>
                        </div>
                      </li>
                    </ul>
                  </div>
                    ...
                    <ul class="footer-contacts d-inline-block d-sm-block">
                      <li>
                        <div class="unit">
                          ...
                          <div class="unit-body"><a class="link-aemail" href="mailto:#">info@africanconnections-usa.com</a></div>
                        </div>
                      </li>
                    </ul>
                  </div>
