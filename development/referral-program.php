...
$page_name = "referral_program"; // UNIVERSAL
$page_controller = new PageController(); // UNIVERSAL
$tracking_controller = new TrackingController(); // UNIVERSAL


$page_banner_class = "referralbanner";
$page_banner_text = "REFERRAL PROGRAM";
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TKNXWNL"
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="page">
      ...
      <!-- DESCRIPTION SECTION-->
      <?php include('src/components/referral-program/description-section.php'); ?>
