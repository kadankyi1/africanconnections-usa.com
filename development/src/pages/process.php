...
$tours_data = [
    'ghana_togo_benin_tour' => [
        ...
        *************************************************************************************************************************/
        ...
        revealed through complex rituals and spectacular performances.',
        'highlights_description_html' => '<strong>DAY 1-3: Travel to Ghana and tour Accra, the capital city of Ghana: </strong> <br><br>
                    ...
                    <strong>></strong> Visit W.E.B. DuBois Memorial Center for Pan-African Culture<br><br>
                    <strong>></strong> Drive through the commercial districts of Accra and see the amazing development and growth of Accra.<br><br>
                    <strong>Days 4-5: Travel to the Asante Region, Naming Ceremony; and tour of Kumasi,and its Surrounding Towns:</strong> <br><br>
                    <strong>></strong> Participate in a Traditional Naming Ceremony and be given a traditional Asante name based on your day of birth<br><br>
                    <strong>></strong> Visit Manhyia Palace the traditional home of the Asantehene, the king of all Asante, and one of the most powerful chiefs 
                    in Africa.<br><br>
                    <strong>></strong> See the Okomfo Anokye Monument, dedicated to the traditional priest who “conjured” from the skies the famous Golden 
                    Stool that unified the Asante people<br><br>
                    <strong>Days 6-7: We tour the Central Region.</strong> <br><br>
                    <strong>></strong> Stop at Assin Manso to participate in a Ceremony of Remembrance at “Slave River”. <br><br>
                    <strong>></strong> Visit the Elmina Slave Dungeon and Cape Coast Slave Dungeons, infamous as the places where the largest number of 
                    enslaved Africans were housed before shipment to the Americas<br><br>
                    <strong>Days 8-9: We tour Lome, the Capital City of Togo</strong> <br><br>
                    <strong>></strong> Independence Square, the fishing harbor, the Lome Craftsmen village; the fetish Market—the traditional “drugstore” and 
                    other products including “sacred” items are on display<br><br>
                    <strong>></strong> Visit the Voodoo Village near Lome<br><br>
                    <strong>></strong> Visit the Slave House in Agbodrafo; and travel by boat to Togoville, the village which was home to numerous enslaved 
                    Africans <br><br>
                    <strong>Days 10-13: OUIDAH VOODOO FESTIVAL; and tour of Cotonou, the Capital City of Benin, and its Surrounding Towns. </strong> <br><br>
                    <strong>></strong> Witness the amazing OUIDAH VOODOO FESTIVAL<br><br>
                    <strong>></strong> We will continue to the place of “the common grave;” the “tree of forgetfulness;” and the infamous “Gate of No Return” 
                    that so many of our ancestors passed through on their journey of enslavement. <br><br>
                    <strong>></strong> Visit to the Ganvie market zone including the international Dantokpa market<br><br>
                    <strong>></strong> Visit the statute of the “Woman King”<br><br>
                    <strong>Days 14-15: Return to Accra, Prepare for Departure and Arrival back in the USA.</strong> <br><br>',
        'package_includes_description_html' => '<strong class="texttogreen">Tour Package Includes</strong><br><br>
                        <strong>></strong> Deluxe Accommodation (twin/double occupancy)<br><br>
                        <strong>></strong> Breakfast Daily<br><br>
                        <strong>></strong> Welcome Dinner and Departure Dinner with Cultural Performances<br><br>
                        <strong>></strong> Ceremony of Remembrance at Slave River<br><br>
                        <strong>></strong> Traditional Naming Ceremony<br><br>
                        <strong>></strong> Participation in Ouidah Voodoo Festival<br><br>
                        <strong>></strong> Transportation throughout in comfortable air-conditioned vehicle<br><br>
                        <strong>></strong> Experienced Driver<br><br>
                        <strong>></strong> Knowledgeable Tour Guide<br><br>
                        <strong>></strong> Entry Fees to all sites visited<br><br>
                        <strong>></strong> Visa Assistance and other predeparture support<br><br>
                        <strong>></strong> Expert tour management and destination support<br><br>
                        <strong> Single Room Upgrade Price $1,000</strong><br><br>',
        'package_excludes_description_html' => '<strong class="texttored">Tour Package Does Not Include</strong> 
                        <br><br>
                        <strong>></strong> Roundtrip air-fare from U.S.A.
                        <br><br>
        ...
        'full_description_html' => '<strong>Benin is considered by many to be the birthplace of voodoo. Every year, on the 10 th of January, the Ouidah 
        region celebrates the Voodoo Festival, an important event dedicated to this religion.</strong><br><br>On this occasion, ceremonies, sacrifices, 
        songs, dances, and large banquets are held; and faith, magic and the supernatural are revealed through complex rituals and spectacular performances.
        <br><br>Our tour will give you the opportunity to witness the amazing OUIDAH VOODOO FESTIVAL, to witness the annual rituals of dancing and drumming 
        to honor this ancient religion.<br><br> Explore Benin’s role in the slave trade. Retrace the route that led enslaved Africans to the “gate of no 
        return” and the ships that transported them to the Americas. See the infamous House of Slaves.<br><br> See the Woman King Statute, which is a 
        tribute to the female warriors made famous in the recent movie starring Viola Davis. Benin is the home of these warriors, the only female army 
        regiment in modern history.<br><br> Our tour will also give you a chance to explore the voodoo culture of Togo. While in this tiny but intriguing 
        country, we visit voodoo temples, fetish market, the Grand Marche, travel by dugout canoe on Togo Lake to reach the mysterious Togoville; and visit 
        Ganvie, a charming village built entirely on stilts.<br><br> This tour also includes tours in Accra, Ghana’s vibrant and cosmopolitan capital, 
    ...
    'black_history_month_tour' => [
        ...
        *************************************************************************************************************************/
        ...
        'highlights_description_html' => '<strong>Day 1 - 4 : Accra, the capital city of Ghana</strong> <br><br>
            <strong>></strong> We will visit Independence Square (where Ghanaians celebrate the nation’s Independence Day each year) and Black Star Square<br><br>
            <strong>></strong> See Jubilee House which is now the official residence and office of the President of Ghana<br><br>
            <strong>></strong> Visit the home of Dr. W.E.B. Dubois, which is now a museum and his final resting place<br><br>
            <strong>></strong> Visit the Kwame Nkrumah Mausoleum, which is the final resting place of the first President of Ghana<br><br>
            <strong>Day 5 - 7 : Kumasi and its Surrounding Towns</strong> <br><br>
            <strong>></strong> Witness the amazing Akwasidae Festival, one of the most important and historically significant festivals in all of Africa<br><br>
            <strong>></strong> Visit the woodcarving village of Ahwiaa, where you will see craftsmen carving wood masterpieces<br><br>
            <strong>></strong> Partake in a Traditional Naming Ceremony, where each tour member will be given a traditional Asante name based on their day of birth<br><br>
            <strong>Day 8 - 10 : Tour Central Region.</strong> <br><br>
            <strong>></strong> Stop at Assin Manso to participate in a Ceremony of Remembrance at “Slave River”<br><br>
            <strong>></strong> Guided tour through Elmina Slave Dungeon and Cape Coast Slave Dungeons',
        'package_includes_description_html' => '<strong class="texttogreen">Tour Package Includes</strong><br><br>
            <strong>></strong> Deluxe Hotel Accommodations (twin/double occupancy)<br><br>
            <strong>></strong> Breakfast Daily<br><br>
            <strong>></strong> Welcome Dinner with Cultural Performances<br><br>
            <strong>></strong> Departure Dinner with Cultural Performances<br><br>
            <strong>></strong> Participation in the Akwasidae Festival<br><br>
            <strong>></strong> Daily Nightlife Options<br><br>
            <strong>></strong> Ceremony of Remembrance at “Slave River”<br><br>
            <strong>></strong> Traditional Naming Ceremony<br><br>
            <strong>></strong> Transportation throughout on a comfortable air-conditioned bus<br><br>
            <strong>></strong> Experienced, Licensed Driver<br><br>
            <strong>></strong> Knowledgeable Tour Guide<br><br>
            <strong>></strong> Tours and Entry Fees to all sites visited<br><br>
            <strong>></strong> Expert tour management and destination support services to help<br><br>
            <strong> Single Room Upgrade Price $900</strong><br><br>',
        'package_excludes_description_html' => '<strong class="texttored">Tour Package Does Not Include</strong><br><br>
            ...
            <strong>></strong> Any other item not specifically included in the tour itinerary',
        'full_description_html' => '<strong>Travel to Ghana, Join our African Heritage tour</strong><br><br>
            February is Black History Month and as we all know, Black History begins in Africa! We invite you to visit Ghana to explore this country’s 
            unique links to African American history. Our Black History Month Tour is coupled with our <a href="returntomotherland.html">"Return to the 
            Motherland African Heritage Tour"</a>.<br><br>Over a period of 400 years millions of Africans were shipped from the dungeons on Ghana’s coast. 
            While many died on the high seas, those that reached the Americas entered into a life of servitude under the system of chattel slavery that 
            attempted to dehumanize them and break them physically and spiritually <br><strong>—And yet, their descendants have survived and flourished.
            </strong> <br><br> The forts/dungeons of Ghana stand as contemporary reminders of the horrific history of slavery. But they also offer the 
            descendants of those millions who passed through the infamous “Doors of No Return” in these houses of horror, the opportunity to RETURN<br>
            <strong>—to DEMONSTRATE THE STRENGTH OF THE AFRICAN SPIRIT AND THE RESILENCE OF THE AFRICAN FAMILY.</strong><br><br>We know all the best places 
    ...
    'panafest_tour' => [
        ...
        *************************************************************************************************************************/
        ...
        'brochure_url' => 'resources/brochures/panafest.pdf',
    ...
    'egypt_tour' => [
        ...
        *************************************************************************************************************************/
        ...
        'highlights_description_html' => '<br><br><strong>DAY 1-3: Experience the Magic of Cairo and the Pyramids</strong> <br><br>
            <strong>></strong> Enjoy an unforgettable Welcome Dinner Cruise on the River Nile with delicious food, live music and Egyptian folk shows<br><br>
            <strong>></strong> Visit the Great Pyramids, at Giza, which includes the Pyramid of Khufu, which is the largest pyramid ever built<br><br>
            <strong>></strong> Walk right up and have a close look at the Sphinx, a huge funeral complex guarded by the legendary lion body with the face of King Chephren<br><br>
            <strong>></strong> Visit the Egyptian Museum of Antiquities, where over 250,000 artifacts illustrating over 5000 years of Egyptian history and art are displayed<br><br>
            <strong>Days 4-5: Fly from Cairo to Luxor and Explore the Ancient Temples.</strong> <br><br>
            <strong>></strong> Take a domestic flight from Cairo to Luxor. Go inside the ancient Temple of Karnak and the Temple of Luxor. Stroll through the famous Temple courtyard and stand under the colossal granite statue of Ramses the Great<br><br>
            <strong>Days 6-9 Enjoy an unforgettable Four-Day Cruise on the River Nile</strong> <br><br>
            <strong>></strong> You will be assigned comfortable rooms that will allow you to relax and enjoy this once in a lifetime experience making stops 
            each day on the cruise at places you have only read about and seen in movies including: The Valley of the Kings, the Colossi of Memnon, and the 
            Temple of Queen Hatshepsut<br><br>
            <strong>></strong> Visit the Temples of Horus in Edfu, and the Temple shared by the two gods Sobek and Haroeris.<br><br>
            <strong>></strong> See breathtaking views while you cruise on this famous ancient river.<br><br>
            <strong>></strong> Visit the colossal Temple of Abu Simbel, built by Ramses the Second, and the Temple of Nefatari, the king’s wife.<br><br>
            <strong>Days 9-10 Return to Cairo, tour Alexandria, and see more of Cairo.</strong> <br><br>
            <strong>></strong> Tour the Library of Alexandria, the biggest library in the world with over 8 million books. Explore this famous library’s 
            relic filled museums and stroll in the Open Court of the Library, where you can see the Statute of Alexander the Great and the Statute of 
            Ptolemy the first, which was found underwater nearby<br><br>
            <strong>></strong> Visit the site of the old Lighthouse, one of the Seven Wonders of the Ancient World on which now stands the Castle of Qaitbey; 
            and walk through the Abbo Elabbas Mosque, the most beautiful and the largest in the city<br><br>
            <strong>></strong> Visit the ancient Roman Amphitheater of Alexandria, with its display of the sunken monuments of Alexandria which were 
            discovered under the harbor of Alexandria<br><br>
            <strong>Days 10-11: Tour the Famous Ancient City of Memphis; Return to Cairo and prepare for the trip back to the United States.</strong> <br><br>
            <strong>></strong> Visit to the Step Pyramids of Zoser, the world’s oldest major stone structure. It was built in the 3 rd Dynasty (around 2630 
            BC) for King Djoser<br><br>
            <strong>></strong> Memphis was founded by King Menes and was the capital of Old Egypt during the Old Kingdom. Memphis was the center of Egyptian 
            culture for over 3000 years<br><br>
            <strong>></strong> See the Statute of Ramses the Second, the Red Pyramid and the Bent Pyramid at Dahshur<br><br>',
        'package_includes_description_html' => '<strong class="texttogreen">Tour Package Includes</strong><br><br>
                        <strong>></strong> Roundtrip air-fare between Cairo and Luxor<br><br>
                        <strong>></strong> Accommodation in Deluxe Hotels (twin/double room occupancy)<br><br>
                        <strong>></strong> Four-day luxury cruise on the Nile River<br><br>
                        <strong>></strong> Breakfast Daily<br><br>
                        <strong>></strong> Six other meals (Lunch/Dinner)<br><br>
                        <strong>></strong> Comfortable air-conditioned bus<br><br>
                        <strong>></strong> Experienced, Licensed English-Speaking Driver<br><br>
                        <strong>></strong> Airport Transfers<br><br>
                        <strong>></strong> Knowledgeable Tour Guide<br><br>
                        <strong>></strong> Entry Fees to all sites visited<br><br>
                        <strong>></strong> Expert tour management and destination support services to help you prepare and to assist you throughout your visit<br><br>
                        <strong> Single Room Upgrade Price $800</strong><br><br>',
        'package_excludes_description_html' => '<strong class="texttored">Tour Package Does Not Include</strong><br><br>
                        ...
                        <strong>></strong> Yellow Fever Immunization Certificate(required)<br><br>
                        <strong>></strong> Any other item not specifically included in the tour itinerary.',
        'full_description_html' => '<strong>Our Egypt "Land Of Pharaohs" African Heritage Tour</strong> includes an unforgettable 4-Day luxury cruise on the 
            River Nile; visits to the Great Pyramids and a close up look at the famous Sphinx. We will explore the Egyptian Museum of Antiquities where over 
            250,000 artifacts illustrating over 5000 years of Egyptian history are on display. This museum houses the King Tutankhamen collection of treasures, 
            gold and jewelry that were enclosed in his tomb for over 3,500 years before it was discovered in the 1920’s.<br><br>We will tour Alexandria, 
            visiting all of the important sites of interest including, the Library of Alexandria, the world’s biggest library, with over 8 million books and 
            browse through this library’s relic filled museum.<br><br>We explore Egypt, visiting Cairo, the West Bank, Luxor, Alexandria, the Valley of the 
    ...
    'return_to_the_motherland_tour' => [
        ...
        *************************************************************************************************************************/
        ...
        'highlights_description_html' => '<br><br><strong>Day 1 - 4 : Accra, the capital city of Ghana</strong> <br><br>
                    <strong>></strong> We will visit the home of Dr. W.E.B. Dubois which is now a museum and his final resting place<br><br>
                    <strong>></strong> See Jubilee House which is now theofficial residence and office of the President of Ghana<br><br>
                    <strong>></strong> Visit Independence Square (where Ghanaians celebrate the nation’s Independence Day each year) and Black Star Square<br><br>
                    <strong>></strong> Visit the Kwame Nkrumah Mausoleum, which is the final resting place of the first President of Ghana<br><br>
                    <strong>></strong> Visit Asenema Waterfall its powerful and enchanting display of cascading water is a natural wonder that will leave you spellbound.<br><br>
                    <strong>Day 5 - 7 : Kumasi and its Surrounding Towns</strong> <br><br>
                    <strong>></strong> Witness the amazing Akwasidae Festival, one of the most important and historically significant festivals in all of Africa<br><br>
                    <strong>></strong> Visit the woodcarving village of Ahwiaa where you will see craftsmen carving wood masterpieces<br><br>
                    <strong>></strong> Partake in Traditional Naming Ceremony, where each tour member will be given a traditional Asante name based on their day of birth<br><br>
                    ...
                    <strong>></strong> Stop at Assin Manso to participate in a Ceremony of Remembrance at “Slave River”<br><br>
                    <strong>></strong> Guided tour through Elmina Slave Dungeon and Cape Coast Slave Dungeons<br><br>',
        'package_includes_description_html' => '<strong class="texttogreen">Tour Package Includes</strong><br><br>
                        <strong>></strong> Accommodation in Deluxe Hotels (twin/double room occupancy)<br><br>
                        <strong>></strong> Breakfast Daily<br><br>
                        <strong>></strong> Welcome Dinner with Cultural Performances<br><br>
                        <strong>></strong> Departure Dinner with Cultural Performances<br><br>
                        <strong>></strong> Participation in Akwasidae Festival<br><br>
                        <strong>></strong> Daily Nightlife Options<br><br>
                        <strong>></strong> Ceremony of Remembrance at “Slave River”<br><br>
                        <strong>></strong> Traditional Naming Ceremony<br><br>
                        <strong>></strong> Transportation throughout on a comfortable air-conditioned bus<br><br>
                        ...
                        <strong>></strong> Knowledgeable Tour Guide<br><br>
                        <strong>></strong> Tours and Entry Fees to all sites visited<br><br>
                        <strong>></strong> Expert tour management and destination support services to help you prepare and assist throughout your visit<br><br>
                        <strong> Single Room Upgrade Price $800</strong><br><br>',
        'package_excludes_description_html' => '<strong class="texttored">Tour Package Does Not Include</strong><br><br>
            <strong>></strong> Airfare<br><br>
            <strong>></strong> COVID 19 Immunization or PCR Test prior to arrival and again upon arrival<br><br>
            ...
            <strong>></strong> Yellow Fever Immunization Certificate(required)<br><br>
            <strong>></strong> Any other item not specifically included in the tour itinerary',
        'full_description_html' => '<strong>Ghana has many exciting traditional festivals and our African Heritage Tour gives you the opportunity to 
            experience one of Africa&#39;s most exciting events. </strong>Festivals are occasions of great cultural pomp and pageantry and are important 
            occasions on the indigenous calendars of several of Ghana&#39;s ethnic groups that bring all of the sons and daughters home from where ever they 
    ...
    'south_africa_tour' => [
        ...
        *************************************************************************************************************************/
        ...
        'image_links' => '',
        'brochure_url' => 'resources/brochures/south_africa_2026.pdf',
...
foreach ($tours_data as $key => $this_tour) {
    try {
        $con =  new PDO("mysql:host=$servername;dbname=$dbname;", $username, $password);
        $con->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

        $id = uniqid();
        $price = str_replace("$", "", $this_tour['price']);
        $price = intval(str_replace(",", "", $price));
        $stmt = $con->prepare("INSERT INTO tours (tour_sys_id, tour_name, tour_start_date, tour_date, tour_duration, tour_countries, tour_price, tour_banner, tour_card_photo, tour_full_photo, tour_image_links, tour_brochure_url, tour_page_url, tour_short_description, tour_highlights_description_html, tour_package_includes_description_html, tour_package_excludes_description_html, tour_full_description_html) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);");
        $stmt->bindParam(1, $key, PDO::PARAM_STR);
        $stmt->bindParam(2, $this_tour['name'], PDO::PARAM_STR);
        $stmt->bindParam(3, $this_tour['start_date'], PDO::PARAM_STR);
        $stmt->bindParam(4, $this_tour['date'], PDO::PARAM_STR);
        $stmt->bindParam(5, $this_tour['duration'], PDO::PARAM_STR);
        $stmt->bindParam(6, $this_tour['countries'], PDO::PARAM_STR);
        $stmt->bindParam(7, $price, PDO::PARAM_STR);
        $stmt->bindParam(8, $this_tour['banner'], PDO::PARAM_STR);
        $stmt->bindParam(9, $this_tour['card_photo'], PDO::PARAM_STR);
        $stmt->bindParam(10, $this_tour['full_photo'], PDO::PARAM_STR);
        $stmt->bindParam(11, $this_tour['image_links'], PDO::PARAM_STR);
        $stmt->bindParam(12, $this_tour['brochure_url'], PDO::PARAM_STR);
        $stmt->bindParam(13, $this_tour['page_url'], PDO::PARAM_STR);
        $stmt->bindParam(14, $this_tour['short_description'], PDO::PARAM_STR);
        $stmt->bindParam(15, $this_tour['highlights_description_html'], PDO::PARAM_STR);
        $stmt->bindParam(16, $this_tour['package_includes_description_html'], PDO::PARAM_STR);
        $stmt->bindParam(17, $this_tour['package_excludes_description_html'], PDO::PARAM_STR);
        $stmt->bindParam(18, $this_tour['full_description_html'], PDO::PARAM_STR);
        if ($stmt->execute() === TRUE) {
            echo "<br><br>success 1";
        }
        $stmt = null;
        $con = null;
