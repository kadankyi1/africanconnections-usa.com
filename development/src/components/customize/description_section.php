        ...
        <div class="container">
          <div class="row row-30 justify-content-center">
            <div class="ofset-lg-2 col-sm-8 col-md-6 col-lg-8">
              ...
              <form id="inquiry_form" action="<?php echo $app->getProtocol() . '://' . $app->getDomain() . $page_controller->getOnePageDetails('thank_you_customize')->url; ?>" method="post" class="paddingallsides10px">
                ...
                <br>
                <div class="relative">
                  <input type="text" required id="travelduration_filled" name="travelduration_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <br>
                <div class="relative">
                  <input type="number" required id="travelersnumber_filled" name="travelersnumber_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <br>
                <div class="relative">
                  <input type="text" required id="interests_filled" name="interests_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <br>
                <div class="relative">
                  <input type="text" required id="fullname_filled" name="fullname_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                ...
                <br>
                <div class="relative">
                  <input type="text" required id="phone_filled" name="phone_filled" class="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm text-gray-900 bg-gray-50 dark:bg-gray-700 border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
              ...
              <br>
                ...
                <span onclick="validateRecaptchaCustomizeTourForm()" class="button button-secondary button-pipaluk">Send</span>
                </div>
              </form>
            </div>
          </div>
