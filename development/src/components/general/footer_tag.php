                  ...
                  <div class="wow slideInRight" data-wow-delay="0s">
                        ...
                        <div class="unit">
                          <div class="unit-body">
                            <a class="d-flex justify-content-center" href="https://www.bbb.org/us/il/bartlett/profile/tour-operators/african-connections-north-america-inc-0654-1000098865" >
                              <img class="center-block" src="<?php echo $root_folder; ?>resources/img/general/bbb/bbb.png" alt="BBB Seal"/>
                            </a>
                          </div>
                        </div>
                      </li>
                    ...
                    <ul class="footer-contacts d-inline-block d-sm-block">
                      <li>
                        <div class="unit">
                          <div class="unit-body">
                            <a class="d-flex justify-content-center" href="<?php echo $app->getProtocol() . '://' . $app->getDomain() . $page_controller->getOnePageDetails('tour_registration')->url; ?>" >
                              Tour Registration
                            </a>
                          </div>
                        </div>
          ...
          <div class="container">
            <div class="row justfy-content-xl-space-berween row-10 align-items-md-center2">
              ...
              <div class="col-sm-6 col-md-4 text-md-right">
                <p class="rights texttowhite"><a href="<?php echo $app->getProtocol() . '://' . $app->getDomain() . $page_controller->getOnePageDetails('terms')->url; ?>" target="_blank">Terms & Conditions</a></p>
              </div>
            </div>
          </div>
        </div>
