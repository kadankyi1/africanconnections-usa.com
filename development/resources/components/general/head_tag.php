...
<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
  ...
  <title><?php echo $page_this->title; ?></title>
    ...
    <link rel="stylesheet" href="<?php echo $root_folder; ?>src/css/bootstrap.css">
    <!--FOR CAROUSEL --- START-->
    ...
    <link rel="stylesheet" href="<?php echo $root_folder; ?>src/css/fonts.css">
    <link rel="stylesheet" href="<?php echo $root_folder; ?>src/css/style.css">
