      ...
      <section class="section section-sm bg-default" >
        <div class="container mt-0" >
          <div class="row row-30 justify-content-center  mt-0">
            <div class="Checkout ofset-lg-2 col-sm-12 col-md-4 col-lg-4">
              <h1>Pay</h1>
              <?php echo $message; ?>                      
              <form class="theForm" action="serverside/payment-process.php" method="post">
              ...
              <div class="row">
                ...
                <div class="payment-field col-sm-12 col-md-12 col-lg-12">
                  <input type="number" name="amt" min="1" placeholder="Payment Amount ($)" autofocus required min="1">
                </div>
                ...
                <div class="select-wrapper col-sm-12 col-md-12 col-lg-12">
                  <select class="select" name="refcode">
