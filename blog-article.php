...
if(!empty($_GET["id"]) && intval($_GET["id"]) > 0){
  ...
  if ($conn->connect_error) {
    ...
    $sql = "SELECT article_title, article_date, id FROM articles ORDER BY id DESC LIMIT 20";
    $result = mysqli_query($conn, $sql);
                ...
                <div class="col-lg-12">
                  <div class="blog-post">
                    ...
                    <div class="down-content">
                      <a><h1 class="fontsize35"><strong><?php echo $article_title; ?></strong></h1></a>
                      <ul class="post-info">
                      ...
                      <div class="post-options">
                        <div class="row">
                          ...
                          <!--
                            <div class="col-6">
                              <ul class="post-share">
                                <li><i class="fa fa-share-alt-alt"></i></li>
