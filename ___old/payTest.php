        ...
        <div class="container mt-0" >
          <div class="row row-30 justify-content-center  mt-0" style="background-color: #f2f2f2; padding: 5px 20px 15px 20px; border: 1px solid lightgrey; border-radius: 3px;">
            <div class="Checkout ofset-lg-3 col-sm-12 col-md-5 col-lg-5">
                ...
                <?php echo $message; ?>          
                <form  action="serverside/pay-process-test.php" id="payform" method="post" class="validate">
                  ...
                  <div class="form-group hidecontent">
                    ...
                    <div class="select-wrapper mr-0 ml-0 mt-0 mb-0 pr-0 pl-0 pt-0 pb-0">
                      <select class="select" id="ordTour" name="refcode" required>
                        ...
                        <option value="Chi Town Ghana Adventure 2025">Chi Town Ghana Adventure 2025</option>
                        ...
                        <option value="PANAFEST Ghana 2025">PANAFEST Ghana 2025</option>
                        ...
                        <option value="Senegal January 2026">Senegal January 2026</option>
                        <option value="Ghana, Togo, Benin 2026">Ghana, Togo, Benin 2026</option>
                        <option value="The Cyres Family Tour">The Cyres Family Tour</option>
                        <option value="Bradford Ghana 2025 Tour">Bradford Ghana 2025 Tour</option>
                        <option value="Grafton Johnson Ghana 2026 Tour">Grafton Johnson Ghana 2026 Tour</option>
                        <option value="Senegal September 2026">Senegal September 2026</option>
                        <option value="Ghana and Senegal November 2025">Ghana and Senegal November 2025</option>
